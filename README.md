...
This is an Content Based Recommender System which recommends movies similar to the movie user likes and analyses the sentiments and the reviews given by the user for that movie.
